  ...
  >
    ...
    >
      ...
      >
        ...
        />
        <span
          class="inline-flex relative items-baseline font-semibold [font-size:var(--font-size)] leading-[1.2] transform-[translateX(calc(var(--effect,0)*var(--max-shift)))] text-[color-mix(in_srgb,var(--accent-color)_calc(var(--effect,0)*100%),var(--text-color))] [-webkit-text-stroke:1px_#000]"
        >
